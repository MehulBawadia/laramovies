...
class ViewTvShowTest extends TestCase
{
    ...
    public function the_tv_index_page_shows_the_correct_info()
    {
        ...
        Http::fake([
            config('services.tmdb.base_url') . '/tv/popular' => $this->fakePopularTv(),
            config('services.tmdb.base_url') . '/tv/top_rated' => $this->fakeHighestRatedTv(),
    ...
    public function the_tv_page_shows_the_correct_info()
    {
        ...
        Http::fake([
            config('services.tmdb.base_url') . '/tv/*' => $this->fakeSingleTv(),
        ]);
