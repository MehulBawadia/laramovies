...
class ViewActorsTest extends TestCase
{
    ...
    {
        Http::fake([
            config('services.tmdb.base_url') .'/person/2888' => $this->fakeActor(),
            config('services.tmdb.base_url') .'/person/2888/external_ids' => $this->fakeSocial(),
            config('services.tmdb.base_url') .'/person/2888/combined_credits' => $this->fakeCredits(),
        ]);
