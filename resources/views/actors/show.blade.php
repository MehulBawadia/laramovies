        ...
        <div class="container mx-auto">
            <div class="px-8 py-16">
                <div class="flex flex-col md:flex-row">
                    <div class="flex-none">
                        <img src="{{ $actor['profile_path'] }}" alt="{{ $actor['name'] }}" class="block mx-auto w-64 lg:w-96" />
                        ...
                        <ul class="mt-4 flex items-center">
                            ...
                            @if ($social['facebook_id'])
                                <li class="ml-6">
                                    <a href="{{ $social['facebook_id'] }}" title="{{ $actor['name'] }} - Facebook" target="_blank">
                            ...
                            @if ($social['instagram_id'])
                                <li class="ml-6">
                                    <a href="{{ $social['instagram_id'] }}" title="{{ $actor['name'] }} - Instagram" target="_blank">
                            ...
                            @if ($social['twitter_id'])
                                <li class="ml-6">
                                    <a href="{{ $social['twitter_id'] }}" title="{{ $actor['name'] }} - Twitter" target="_blank">
                    ...
                    <div class="md:ml-24 mt-8 md:mt-0">
                        <h1 class="text-4xl font-bold">{{ $actor['name'] }}</h1>
                        ...
                        <div class="flex flex-wrap items-center text-gray-400 text-sm mt-2">
                            ...
                            <span class="ml-2">{{ $actor['birthday'] }} ({{ $actor['age'] }} years) in {{ $actor['place_of_birth'] }}</span>
                            <span class="mx-2">|</span>
                            <span>More Stuff Here</span>
                        </div>

                        <div class="mt-12 text-gray-300">{{ $actor['biography'] }}</div>
