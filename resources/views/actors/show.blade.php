...
{{-- @section('titles')
    <title>{{ $actor['name'] }} | {{ config('app.name') }}</title>
@endsection --}}
        ...
        <div class="container mx-auto">
            <div class="px-8 py-16">
                <div class="flex flex-col md:flex-row">
                    <div class="flex-none">
                        <img src="https://image.tmdb.org/t/p/w300/r5yu8cnSaVA36j0CTSC8TjiYYE5.jpg" alt="Gemma Chan" class="block mx-auto w-64 lg:w-96" />
                    ...
                    <div class="md:ml-24 mt-8 md:mt-0">
                        <h1 class="text-4xl font-bold">Gemma Chan</h1>
                        ...
                        <div class="flex flex-wrap items-center text-gray-400 text-sm mt-2">
                            ...
                            <span class="ml-2">Feb 20, 1983 (37 years) in UK</span>
                            <span class="mx-2">|</span>
                            <span>More Stuff Here</span>
                        </div>

                        <p class="mt-12 text-gray-300">Lorem ipsum dolor sit amet, consectetur adipisicing, elit. Aliquid architecto totam eos commodi quas possimus in, incidunt, ea. Suscipit vel beatae itaque eaque sequi voluptates. Dolores eius dignissimos dicta, magni, doloremque possimus voluptas id vitae incidunt? Perferendis corporis eius, facere deserunt quas, recusandae unde, qui deleniti est, atque laboriosam et.</p>

                        <h4 class="mt-12 font-bold">Known For</h4>
                        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cold-4 lg:grid-cols-5 gap-8">
                            <div class="mt-4">
                                <a href="#">
                                    <img src="https://image.tmdb.org/t/p/w300/1XxL4LJ5WHdrcYcihEZUCgNCpAW.jpg" alt="poster" class="hover:opacity-75 transition ease-in-out duration-150">
                                </a>

                                <a href="#" class="text-sm leading-none hover:text-gray-300 focus:text-gray-300 focus:outline-none">
                                    Crazy Rich Asians
                                </a>
                            </div>
                            <div class="mt-4">
        ...
        <div class="container mx-auto">
            <div class="px-8 py-16">
                ...
                <ul class="list-disc leading-loose pl-5 mt-8">
                    <li>
                        {{ date('Y') }} &middot;
                        <strong><a href="#" class="hover:underline">Movie Name</a></strong>
                         as Character Name
                     </li>
                </ul>
            </div>
