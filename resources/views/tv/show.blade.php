...
@section('title')
    <title>{{ $tvShow['name'] }} | {{ config('app.name') }}</title>
@endsection
        ...
        <div class="container mx-auto">
            <div class="px-8 py-16">
                <div class="flex flex-col md:flex-row">
                    <img src="{{ $tvShow['poster_path'] }}" alt="{{ $tvShow['name'] }}" class="block mx-auto w-64 lg:w-96" />
                    ...
                    <div class="md:ml-24 mt-8 md:mt-0">
                        ...
                        <p class="mt-12 text-gray-300">{{ $tvShow['overview'] }}</p>
                        ...
                        <div x-data="{ isOpen: false }">
                            @if (count($tvShow['videos']['results']) > 0)
                                <div class="mt-12">
                                    <button @click="isOpen = true" class="inline-flex items-center bg-yellow-600 text-gray-900 rounded font-bold px-5 py-4 hover:bg-yellow-700 focus:bg-yellow-700 focus:outline-none transition ease-in-out duration-150">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8">
                    @foreach ($tvShow['cast'] as $cast)
                        <div class="mt-8">
                            ...
                            <div class="mt-2">
                                <a href="{{ route('actors.show', $cast['id']) }}" class="text-lg hover:text-gray-300 focus:text-gray-300 focus:outline-none">{{ $cast['name'] }}</a>
