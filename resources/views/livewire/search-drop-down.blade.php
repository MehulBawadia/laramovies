<div class="relative mt-3 md:mt-0">
    <input wire:model.debouce.500ms="search" type="text" class="bg-gray-800 text-sm rounded-full w-64 pl-8 py-1 focus:outline-none focus:ring" placeholder="Search..." />
    ...
    @if (strlen($search) >= 2)
        <div class="absolute text-sm bg-gray-800 rounded w-64 mt-2">
            <ul>
                @forelse ($searchResults as $result)
                    <li class="border-b border-gray-700">
                        <a href="{{ route('movies.show', $result['id']) }}" class="block px-3 py-2 hover:bg-gray-700 flex items-center">
