        ...
        <div class="flex flex-col md:flex-row items-center justify-between px-8 py-6">
            <ul class="flex flex-col md:flex-row items-center">
                ...
                <li class="md:ml-16 mt-3 md:mt-0">
                    <a href="{{ route('movies.index') }}" class="hover:text-gray-300 focus:text-gray-300 focus:outline-none">Movies</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="#" class="hover:text-gray-300 focus:text-gray-300 focus:outline-none">TV Shows</a>
                </li>
                <li class="md:ml-6 mt-3 md:mt-0">
                    <a href="#" class="hover:text-gray-300 focus:text-gray-300 focus:outline-none">Actors</a>
                </li>
            </ul>

            <div class="flex flex-col md:flex-row items-center">
                <div class="relative mt-3 md:mt-0">
                    <input type="text" class="bg-gray-800 text-sm rounded-full w-64 pl-8 py-1 focus:outline-none focus:ring" placeholder="Search..." />
